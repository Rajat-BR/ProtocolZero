...
tests/test_auth.py::test_login_valid PASSED                             [  4%]
tests/test_auth.py::test_login_invalid PASSED                           [  8%]
tests/test_payment.py::test_charge_success PASSED                       [ 12%]
tests/test_payment.py::test_refund FAILED                               [ 16%]
tests/test_payment.py::test_partial_refund FAILED                       [ 20%]
...
FAILED tests/test_payment.py::test_refund - AssertionError: assert 'pending' == 'refunded'
FAILED tests/test_payment.py::test_partial_refund - AssertionError: assert 0 == 150.0
...
Error: Process completed with exit code 1.
##[error]Server failed to start. Missing required environment variables.
"""
